...
class Atri:
	def __init__(self, state: Any):
		...
		self.container_default = state["container_default"]
		self.header_wrapper = state["header_wrapper"]
		self.header_left = state["header_left"]
		self.header_right = state["header_right"]
		self.navigation_menu = state["navigation_menu"]
		self.navigation_item = state["navigation_item"]
		self.Div5 = state["Div5"]
		self.Div6 = state["Div6"]
		self.Div7 = state["Div7"]
		self.section = state["section"]
		self.Flex28 = state["Flex28"]
		self.underline_heading = state["underline_heading"]
		...
		self.image_container = state["image_container"]
		...
		self.link_arrow_wrapper = state["link_arrow_wrapper"]
		self.link_arrow_text = state["link_arrow_text"]
		self.Flex70 = state["Flex70"]
		self.Div61 = state["Div61"]
		self.w_layout_grid = state["w_layout_grid"]
		self.layout_left = state["layout_left"]
		...
		self.bottom_content = state["bottom_content"]
		...
		self.w_container = state["w_container"]
		self.top_content_articles = state["top_content_articles"]
		self.Flex91 = state["Flex91"]
		self.article_list = state["article_list"]
		self.article_card_wrapper = state["article_card_wrapper"]
		self.article = state["article"]
		self.article_left = state["article_left"]
		self.flex_center_details_article = state["flex_center_details_article"]
		...
		self.interested_section = state["interested_section"]
		self.interested_container = state["interested_container"]
		self.interested_grid = state["interested_grid"]
		self.Div137 = state["Div137"]
		self.Flex106 = state["Flex106"]
		self.footer = state["footer"]
		self.footer_container = state["footer_container"]
		self.footer_bottom = state["footer_bottom"]
		self.social_icons_footer_wrapper = state["social_icons_footer_wrapper"]
		self.social_icon_footer = state["social_icon_footer"]
		...
		self.footer_top = state["footer_top"]
		self.Div141 = state["Div141"]
		self.w_form = state["w_form"]
		self.subscribe_footer = state["subscribe_footer"]
		self.Div142 = state["Div142"]
		self.footer_columns = state["footer_columns"]
		self.footer_nav_column = state["footer_nav_column"]
		...
		self.navigation_text = state["navigation_text"]
		...
		self.article_title = state["article_title"]
		self.TextBox158 = state["TextBox158"]
		self.text_divider = state["text_divider"]
		...
		self.footer_nav_item = state["footer_nav_item"]
		...
		self.footer_menu_title = state["footer_menu_title"]
	...
	@property
	def container_default(self):
		self._getter_access_tracker["container_default"] = {}
		return self._container_default
	@container_default.setter
	def container_default(self, new_state):
		self._setter_access_tracker["container_default"] = {}
		global default_state
		self._container_default = Div(new_state, default_state["container_default"])

	@property
	def header_wrapper(self):
		self._getter_access_tracker["header_wrapper"] = {}
		return self._header_wrapper
	@header_wrapper.setter
	def header_wrapper(self, new_state):
		self._setter_access_tracker["header_wrapper"] = {}
		global default_state
		self._header_wrapper = Flex(new_state, default_state["header_wrapper"])
	...
	def header_left(self, new_state):
		...
		global default_state
		self._header_left = Div(new_state, default_state["header_left"])

	@property
	def header_right(self):
		self._getter_access_tracker["header_right"] = {}
		return self._header_right
	@header_right.setter
	def header_right(self, new_state):
		self._setter_access_tracker["header_right"] = {}
		global default_state
		self._header_right = Flex(new_state, default_state["header_right"])

	@property
	def navigation_menu(self):
		self._getter_access_tracker["navigation_menu"] = {}
		return self._navigation_menu
	@navigation_menu.setter
	def navigation_menu(self, new_state):
		self._setter_access_tracker["navigation_menu"] = {}
		global default_state
		self._navigation_menu = Flex(new_state, default_state["navigation_menu"])

	@property
	def navigation_item(self):
		self._getter_access_tracker["navigation_item"] = {}
		return self._navigation_item
	@navigation_item.setter
	def navigation_item(self, new_state):
		self._setter_access_tracker["navigation_item"] = {}
		global default_state
		self._navigation_item = Div(new_state, default_state["navigation_item"])
	...
	@property
	def underline_heading(self):
		self._getter_access_tracker["underline_heading"] = {}
		return self._underline_heading
	@underline_heading.setter
	def underline_heading(self, new_state):
		self._setter_access_tracker["underline_heading"] = {}
		global default_state
		self._underline_heading = Div(new_state, default_state["underline_heading"])
	...
	def projects_list(self):
		self._getter_access_tracker["projects_list"] = {}
		return self._projects_list
	@projects_list.setter
	def projects_list(self, new_state):
		self._setter_access_tracker["projects_list"] = {}
		global default_state
		self._projects_list = Flex(new_state, default_state["projects_list"])

	@property
	def project_item(self):
		self._getter_access_tracker["project_item"] = {}
		return self._project_item
	@project_item.setter
	def project_item(self, new_state):
		self._setter_access_tracker["project_item"] = {}
		global default_state
		self._project_item = Flex(new_state, default_state["project_item"])
	...
	def image_container(self):
		self._getter_access_tracker["image_container"] = {}
		return self._image_container
	@image_container.setter
	def image_container(self, new_state):
		self._setter_access_tracker["image_container"] = {}
		global default_state
		self._image_container = Div(new_state, default_state["image_container"])
	...
	@property
	def link_arrow_wrapper(self):
		self._getter_access_tracker["link_arrow_wrapper"] = {}
		return self._link_arrow_wrapper
	@link_arrow_wrapper.setter
	def link_arrow_wrapper(self, new_state):
		self._setter_access_tracker["link_arrow_wrapper"] = {}
		global default_state
		self._link_arrow_wrapper = Flex(new_state, default_state["link_arrow_wrapper"])

	@property
	def link_arrow_text(self):
		self._getter_access_tracker["link_arrow_text"] = {}
		return self._link_arrow_text
	@link_arrow_text.setter
	def link_arrow_text(self, new_state):
		self._setter_access_tracker["link_arrow_text"] = {}
		global default_state
		self._link_arrow_text = Flex(new_state, default_state["link_arrow_text"])
	...
	@property
	def w_layout_grid(self):
		self._getter_access_tracker["w_layout_grid"] = {}
		return self._w_layout_grid
	@w_layout_grid.setter
	def w_layout_grid(self, new_state):
		self._setter_access_tracker["w_layout_grid"] = {}
		global default_state
		self._w_layout_grid = Flex(new_state, default_state["w_layout_grid"])

	@property
	def layout_left(self):
		self._getter_access_tracker["layout_left"] = {}
		return self._layout_left
	@layout_left.setter
	def layout_left(self, new_state):
		self._setter_access_tracker["layout_left"] = {}
		global default_state
		self._layout_left = Div(new_state, default_state["layout_left"])
	...
	def container(self, new_state):
		...
		global default_state
		self._container = Div(new_state, default_state["container"])
	...
	def bottom_content(self):
		self._getter_access_tracker["bottom_content"] = {}
		return self._bottom_content
	@bottom_content.setter
	def bottom_content(self, new_state):
		self._setter_access_tracker["bottom_content"] = {}
		global default_state
		self._bottom_content = Flex(new_state, default_state["bottom_content"])
	...
	@property
	def w_container(self):
		self._getter_access_tracker["w_container"] = {}
		return self._w_container
	@w_container.setter
	def w_container(self, new_state):
		self._setter_access_tracker["w_container"] = {}
		global default_state
		self._w_container = Div(new_state, default_state["w_container"])

	@property
	def top_content_articles(self):
		self._getter_access_tracker["top_content_articles"] = {}
		return self._top_content_articles
	@top_content_articles.setter
	def top_content_articles(self, new_state):
		self._setter_access_tracker["top_content_articles"] = {}
		global default_state
		self._top_content_articles = Flex(new_state, default_state["top_content_articles"])
	...
	def article_list(self):
		self._getter_access_tracker["article_list"] = {}
		return self._article_list
	@article_list.setter
	def article_list(self, new_state):
		self._setter_access_tracker["article_list"] = {}
		global default_state
		self._article_list = Flex(new_state, default_state["article_list"])

	@property
	def article_card_wrapper(self):
		self._getter_access_tracker["article_card_wrapper"] = {}
		return self._article_card_wrapper
	@article_card_wrapper.setter
	def article_card_wrapper(self, new_state):
		self._setter_access_tracker["article_card_wrapper"] = {}
		global default_state
		self._article_card_wrapper = Div(new_state, default_state["article_card_wrapper"])

	@property
	def article(self):
		self._getter_access_tracker["article"] = {}
		return self._article
	@article.setter
	def article(self, new_state):
		self._setter_access_tracker["article"] = {}
		global default_state
		self._article = Flex(new_state, default_state["article"])

	@property
	def article_left(self):
		self._getter_access_tracker["article_left"] = {}
		return self._article_left
	@article_left.setter
	def article_left(self, new_state):
		self._setter_access_tracker["article_left"] = {}
		global default_state
		self._article_left = Div(new_state, default_state["article_left"])

	@property
	def flex_center_details_article(self):
		self._getter_access_tracker["flex_center_details_article"] = {}
		return self._flex_center_details_article
	@flex_center_details_article.setter
	def flex_center_details_article(self, new_state):
		self._setter_access_tracker["flex_center_details_article"] = {}
		global default_state
		self._flex_center_details_article = Flex(new_state, default_state["flex_center_details_article"])
	...
	@property
	def interested_section(self):
		self._getter_access_tracker["interested_section"] = {}
		return self._interested_section
	@interested_section.setter
	def interested_section(self, new_state):
		self._setter_access_tracker["interested_section"] = {}
		global default_state
		self._interested_section = Div(new_state, default_state["interested_section"])

	@property
	def interested_container(self):
		self._getter_access_tracker["interested_container"] = {}
		return self._interested_container
	@interested_container.setter
	def interested_container(self, new_state):
		self._setter_access_tracker["interested_container"] = {}
		global default_state
		self._interested_container = Div(new_state, default_state["interested_container"])

	@property
	def interested_grid(self):
		self._getter_access_tracker["interested_grid"] = {}
		return self._interested_grid
	@interested_grid.setter
	def interested_grid(self, new_state):
		self._setter_access_tracker["interested_grid"] = {}
		global default_state
		self._interested_grid = Flex(new_state, default_state["interested_grid"])
	...
	def footer_container(self, new_state):
		...
		global default_state
		self._footer_container = Div(new_state, default_state["footer_container"])

	@property
	def footer_bottom(self):
		self._getter_access_tracker["footer_bottom"] = {}
		return self._footer_bottom
	@footer_bottom.setter
	def footer_bottom(self, new_state):
		self._setter_access_tracker["footer_bottom"] = {}
		global default_state
		self._footer_bottom = Flex(new_state, default_state["footer_bottom"])

	@property
	def social_icons_footer_wrapper(self):
		self._getter_access_tracker["social_icons_footer_wrapper"] = {}
		return self._social_icons_footer_wrapper
	@social_icons_footer_wrapper.setter
	def social_icons_footer_wrapper(self, new_state):
		self._setter_access_tracker["social_icons_footer_wrapper"] = {}
		global default_state
		self._social_icons_footer_wrapper = Flex(new_state, default_state["social_icons_footer_wrapper"])

	@property
	def social_icon_footer(self):
		self._getter_access_tracker["social_icon_footer"] = {}
		return self._social_icon_footer
	@social_icon_footer.setter
	def social_icon_footer(self, new_state):
		self._setter_access_tracker["social_icon_footer"] = {}
		global default_state
		self._social_icon_footer = Div(new_state, default_state["social_icon_footer"])
	...
	@property
	def footer_top(self):
		self._getter_access_tracker["footer_top"] = {}
		return self._footer_top
	@footer_top.setter
	def footer_top(self, new_state):
		self._setter_access_tracker["footer_top"] = {}
		global default_state
		self._footer_top = Flex(new_state, default_state["footer_top"])
	...
	@property
	def w_form(self):
		self._getter_access_tracker["w_form"] = {}
		return self._w_form
	@w_form.setter
	def w_form(self, new_state):
		self._setter_access_tracker["w_form"] = {}
		global default_state
		self._w_form = Div(new_state, default_state["w_form"])

	@property
	def subscribe_footer(self):
		self._getter_access_tracker["subscribe_footer"] = {}
		return self._subscribe_footer
	@subscribe_footer.setter
	def subscribe_footer(self, new_state):
		self._setter_access_tracker["subscribe_footer"] = {}
		global default_state
		self._subscribe_footer = Flex(new_state, default_state["subscribe_footer"])
	...
	def footer_columns(self):
		self._getter_access_tracker["footer_columns"] = {}
		return self._footer_columns
	@footer_columns.setter
	def footer_columns(self, new_state):
		self._setter_access_tracker["footer_columns"] = {}
		global default_state
		self._footer_columns = Flex(new_state, default_state["footer_columns"])

	@property
	def footer_nav_column(self):
		self._getter_access_tracker["footer_nav_column"] = {}
		return self._footer_nav_column
	@footer_nav_column.setter
	def footer_nav_column(self, new_state):
		self._setter_access_tracker["footer_nav_column"] = {}
		global default_state
		self._footer_nav_column = Flex(new_state, default_state["footer_nav_column"])
	...
	def navigation_text(self):
		self._getter_access_tracker["navigation_text"] = {}
		return self._navigation_text
	@navigation_text.setter
	def navigation_text(self, new_state):
		self._setter_access_tracker["navigation_text"] = {}
		global default_state
		self._navigation_text = TextBox(new_state, default_state["navigation_text"])
	...
	def article_title(self):
		self._getter_access_tracker["article_title"] = {}
		return self._article_title
	@article_title.setter
	def article_title(self, new_state):
		self._setter_access_tracker["article_title"] = {}
		global default_state
		self._article_title = TextBox(new_state, default_state["article_title"])
	...
	@property
	def text_divider(self):
		self._getter_access_tracker["text_divider"] = {}
		return self._text_divider
	@text_divider.setter
	def text_divider(self, new_state):
		self._setter_access_tracker["text_divider"] = {}
		global default_state
		self._text_divider = Div(new_state, default_state["text_divider"])
	...
	@property
	def footer_nav_item(self):
		self._getter_access_tracker["footer_nav_item"] = {}
		return self._footer_nav_item
	@footer_nav_item.setter
	def footer_nav_item(self, new_state):
		self._setter_access_tracker["footer_nav_item"] = {}
		global default_state
		self._footer_nav_item = TextBox(new_state, default_state["footer_nav_item"])
	...
	@property
	def footer_menu_title(self):
		self._getter_access_tracker["footer_menu_title"] = {}
		return self._footer_menu_title
	@footer_menu_title.setter
	def footer_menu_title(self, new_state):
		self._setter_access_tracker["footer_menu_title"] = {}
		global default_state
		self._footer_menu_title = TextBox(new_state, default_state["footer_menu_title"])
	...
	def _to_json_fields(self):
		return {
			"container_default": self._container_default,
			"header_wrapper": self._header_wrapper,
			"header_left": self._header_left,
			"header_right": self._header_right,
			"navigation_menu": self._navigation_menu,
			"navigation_item": self._navigation_item,
			"Div5": self._Div5,
			"Div6": self._Div6,
			"Div7": self._Div7,
			"section": self._section,
			"Flex28": self._Flex28,
			"underline_heading": self._underline_heading,
			"Div29": self._Div29,
			...
			"Flex65": self._Flex65,
			"Div59": self._Div59,
			"link_arrow_wrapper": self._link_arrow_wrapper,
			"link_arrow_text": self._link_arrow_text,
			"Flex70": self._Flex70,
			"Div61": self._Div61,
			"w_layout_grid": self._w_layout_grid,
			"layout_left": self._layout_left,
			...
			"Div105": self._Div105,
			"w_container": self._w_container,
			"top_content_articles": self._top_content_articles,
			"Flex91": self._Flex91,
			"article_list": self._article_list,
			"article_card_wrapper": self._article_card_wrapper,
			"article": self._article,
			"article_left": self._article_left,
			"flex_center_details_article": self._flex_center_details_article,
			"Div116": self._Div116,
			"Div125": self._Div125,
			"Flex99": self._Flex99,
			"Div123": self._Div123,
			"Div124": self._Div124,
			"Flex98": self._Flex98,
			"interested_section": self._interested_section,
			"interested_container": self._interested_container,
			"interested_grid": self._interested_grid,
			"Div137": self._Div137,
			"Flex106": self._Flex106,
			"footer": self._footer,
			"footer_container": self._footer_container,
			"footer_bottom": self._footer_bottom,
			"social_icons_footer_wrapper": self._social_icons_footer_wrapper,
			"social_icon_footer": self._social_icon_footer,
			"Div151": self._Div151,
			"Div152": self._Div152,
			"Div153": self._Div153,
			"Div154": self._Div154,
			...
			"Div141": self._Div141,
			"w_form": self._w_form,
			"subscribe_footer": self._subscribe_footer,
			"Div142": self._Div142,
			"footer_columns": self._footer_columns,
			"footer_nav_column": self._footer_nav_column,
			...
			"Image3": self._Image3,
			"Image4": self._Image4,
			"navigation_text": self._navigation_text,
			...
			"text_divider": self._text_divider,
			...
			"footer_nav_item": self._footer_nav_item,
			...
			"footer_menu_title": self._footer_menu_title,
